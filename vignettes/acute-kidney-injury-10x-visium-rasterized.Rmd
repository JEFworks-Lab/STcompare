...
gene1_plt_ctrl  <- SEraster::plotRaster(rast$AKI_ctrl[gene1, ], assay_name = "CPM", name = "CPM expression")
gene1_plt_aki <- SEraster::plotRaster(rast$AKI_aki[gene1, ], assay_name = "CPM", name = "CPM expression")
gene1_plt_ctrl + gene1_plt_aki

gene2_plt_ctrl  <- SEraster::plotRaster(rast$AKI_ctrl[gene2, ], assay_name = "CPM", name = "CPM expression")
gene2_plt_aki <- SEraster::plotRaster(rast$AKI_aki[gene2, ], assay_name = "CPM", name = "CPM expression")
