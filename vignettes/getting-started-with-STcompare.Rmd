...
plot_df <- data.frame(
  niave_neglog_pval_bh_correct = cors_df$log_bh,
  emperical_neglog_pva_pval = cors_df$log_corrected
)
...
niave_sig <- plot_df[plot_df$niave_neglog_pval_bh_correct > -log10(0.05), ]
niave_sig_per <- dim(niave_sig)[1] / dim(plot_df)[1]
niave_sig_per
dim(niave_sig)[1]

emperical_sig <- plot_df[plot_df$emperical_neglog_pva_pval > -log10(0.05), ]
