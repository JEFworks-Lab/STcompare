...
aki_STalign <- read.csv(zenodo_url, header = TRUE, row.names =1)
...
kidneyCorrelation <- STcompare::spatialCorrelationGeneExp(
  ...
  nThreads = 5, # parallelize genes across threads
...
start_time <- Sys.time()
ss <- STcompare::spatialSimilarity(input, foldChange = 1, assayName = "CPM", t1 = NULL, t2 = NULL)
end_time <- Sys.time()
print(end_time-start_time)
```
